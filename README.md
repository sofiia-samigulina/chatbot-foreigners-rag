...
A Retrieval-Augmented Generation (RAG) pipeline for answering questions about Slovak legislation in plain language - making legal information accessible to non-native speakers and foreigners in Slovakia.

## Motivation
Understanding legal requirements in a foreign country is challenging. This project aims to bridge the gap between complex legal texts and everyday users by providing clear, context-aware answers based on official Slovak laws.
